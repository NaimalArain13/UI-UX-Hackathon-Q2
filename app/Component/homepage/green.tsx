...
function GreenSection() {
  return (
    <div className='bg-[#23856D] py-7'>
    <div className=' flex flex-col md:flex-row justify-center items-center gap-4 md:px-11'>
    <div className='md:w-1/2 w-full flex flex-col justify-center items-center sm:items-start gap-5 sm:px-7 md:px-9 px-3 sm:text-left text-center'>
